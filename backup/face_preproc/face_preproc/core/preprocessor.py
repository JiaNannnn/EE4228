"""
Face Preprocessor Core Module

This module provides the main face preprocessing functionality:
1. Face detection using multiple methods
...
class FacePreprocessor:
    ...
    def __init__(self, target_size=(224, 224), force_grayscale=True):
        ...
        try:
            # Check for models in standard locations
            model_dirs = [
            ...
            for model_dir in model_dirs:
                ...
                if os.path.exists(prototxt_path) and os.path.exists(caffemodel_path):
                    ...
                    logger.info(f"DNN face detector loaded from {model_dir}")
                    found_models = True
                    break
